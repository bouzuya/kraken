...
var compileImpl = function compileImpl(inDir, outDir, list, parse, noTokensJson) {
    ...
    return Promise.resolve().then(function () {
        ...
        return noTokensJson === false ? saveTokensJson(repository, outDir) : void 0;
    }).then(function () {
        return void 0;
    });
};
var compile = function compile(inDir, outDir, options) {
    console.log('DEPRECATED: Use `build()`');
    var noTokensJson = typeof options === 'undefined' ? false : options.noTokensJson;
    return compileImpl(inDir, outDir, bbn_1.listEntryIds, bbn_1.parseEntry, noTokensJson);
};
exports.compile = compile;
var compileOld = function compileOld(inDir, outDir) {
    console.log('DEPRECATED:');
    return compileImpl(inDir, outDir, jekyll_1.listEntryIds, jekyll_1.parseEntry, true);
};
exports.compileOld = compileOld;
var compileNew = compile;
exports.compileNew = compileNew;
var build = function build(inDir, outDir, options) {
    var noTokensJson = typeof options === 'undefined' ? false : options.noTokensJson;
    return compileImpl(inDir, outDir, bbn_1.listEntryIds, bbn_1.parseEntry, noTokensJson);
};
exports.build = build;